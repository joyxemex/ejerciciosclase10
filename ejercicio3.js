//● Ejercicio 3 – Constantes / Validación de Edad: Más adelante vamos a querer validar que 
// nuestros encuestados sean de 18 años de edad mínima y 99 años de edad máxima.
...
if (edadUsuario >= EDAD_MINIMA && edadUsuario <= EDAD_MAXIMA) {
    console.log ("tu edad es ( "+ edadUsuario + ") puedes entrar ");
} else{
    console.log ("tu edad esta fuera del rango permitido"); 
}